                ...
                <div class="col-lg-4 left-column">
                    <div class="why-choose-us-block-two inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <h4>Gain De Temps</h4>
                            <div class="text">sera un gain de temps en termes de production.</div>
                        </div>
                    </div>
                    <div class="why-choose-us-block-two inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="3000ms">
                        <div class="inner-box">
                            ...
                            <div class="text">fournisseur leader de solutions technologiques qui inspirent la grandeur.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 right-column order-lg-2">
                    <div class="why-choose-us-block-two inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="text">Ces cas sont parfaitement simples faciles.</div>
                        </div>
                    </div>
                    <div class="why-choose-us-block-two inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="3000ms">
                        <div class="inner-box">
                            ...
                            <h4>Propre & Non Pollué</h4>
                            <div class="text">Évitez la pollution causée par les déchets plastiques.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="image" style="text-align: center"><img style="width:75%;" src="{{asset('frontend/mvx-h.c4ceba3c.png')}}" alt=""></div>
                </div>
            </div>
        </div>
